...
Create professional infographics in the MattAI brand style for LinkedIn and newsletters. Uses Gemini AI via the Nano Banana MCP server for image generation.
...
|---|---|---|
| Layer 4 >= Layer 3 | **Data-led hybrid** | An Information Graphic (MattAI brand system, cards, data structures) with an emotionally resonant headline or framing from Layer 3. The infographic IS the output. The claim provides the hook. |
  ...
  - question: "What type of visual should this be?"
    ...
    options:
      - label: "Infographic (Recommended)"
        description: "Clean data visual using MattAI brand system. Cards, scorecards, diagrams. Best for frameworks and comparisons."
...
|---|---|
| **Infographic** | Information Graphic (or Data-led Hybrid if both layers were strong). Lock MattAI brand system as the style. |
...
State the locked mode after selection: "Got it -- clean infographic using the MattAI brand system." or "Got it -- editorial illustration in the risograph style."
