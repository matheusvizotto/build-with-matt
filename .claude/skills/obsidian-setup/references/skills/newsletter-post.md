...
1. **Subject line** — max 50 characters, 3 options always, no emojis, no clickbait
2. **Hook stat or observation** — direct, no warmup
3. **Main insight** — one topic only, 70% of the edition
4. **3 practical takeaways** — concrete, actionable
5. **One CTA** — max 2 CTAs per edition
6. **P.S.** — always present, intentional (drives 25-40% of clicks)
