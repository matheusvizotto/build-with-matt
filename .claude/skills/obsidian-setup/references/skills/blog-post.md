...
**Opening (40-60 words):**
1. One sentence naming the problem or claim (with a stat if possible)
2. One sentence with the direct answer
3. One sentence framing what the post covers
...
### SEO/AEO Checklist (before publishing)

- [ ] Opening paragraph: 40-60 words, direct answer to primary query
- [ ] 60-70% of H2 headings phrased as questions
- [ ] Every H2 opens with a 40-60 word self-contained answer
- [ ] FAQ section at bottom (minimum 5 Q&As)
- [ ] At least one data table
- [ ] Word count: 1,500-2,500 (spoke) or 3,000-4,000 (pillar)
- [ ] Minimum 8 external citations from tier 1-3 sources
- [ ] Minimum 5 internal links
- [ ] Minimum 2 images or visuals
- [ ] Article + FAQPage schema on publish
...
1. Write post (target word count for type)
2. Add FAQ section (5+ Q&As)
3. Add external citations (8+ tier 1-3 sources)
